#!/bin/bash
#SBATCH --job-name=unetvqvae_stage1_dino_restart
#SBATCH --output=/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/logs/stage1_dino_restart_%j.out
#SBATCH --error=/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/logs/stage1_dino_restart_%j.err
#SBATCH --nodes=1
...
OUTPUT_DIR="/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/outputs/stage1_dino_restart"
mkdir -p $OUTPUT_DIR
...
torchrun \
    ...
    --wandb_run_name stage1_dino_restart
