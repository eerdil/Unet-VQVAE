#!/bin/bash
#SBATCH --job-name=unetvqvae_stage1_restart
#SBATCH --output=/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/logs/stage1_restart_%j.out
#SBATCH --error=/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/logs/stage1_restart_%j.err
#SBATCH --nodes=1
...
OUTPUT_DIR="/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/outputs/stage1_restart"
mkdir -p $OUTPUT_DIR
