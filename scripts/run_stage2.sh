#!/bin/bash
#SBATCH --job-name=unetvqvae_stage2
#SBATCH --output=/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/logs/stage2_%j.out
#SBATCH --error=/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/logs/stage2_%j.err
#SBATCH --nodes=1
...
STAGE1_CKPT="/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/outputs/stage1/stage1_final.pth"
OUTPUT_DIR="/usr/bmicnas02/data-biwi-01/erdile_data/projects/GenerativeUnet/outputs/stage2"
mkdir -p $OUTPUT_DIR
...
torchrun \
    ...
    --wandb_run_name stage2_baseline
